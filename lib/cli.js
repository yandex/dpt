...
_commander2.default.version('0.1.0').usage('dpt <command> [options]').command('init <name>').description('Create a Depot project').action(init).command('start').description('Run a project').action(start);
