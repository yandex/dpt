...
;(function () {
    ...
    function stringifyObject(ctx) {
        if (Array.isArray(ctx)) {
            ...
            string += ']';
            return string;
        } else if ((typeof ctx === 'undefined' ? 'undefined' : _typeof(ctx)) === 'object') {
            var string = '{';
            for (var key in ctx) {
    ...
    function cloneObject(ctx) {
        if (Array.isArray(ctx)) {
            var array = [];
            for (var i = 0, ii = ctx.length; i < ii; i++) {
                array.push(cloneObject(ctx[i]));
            }
            return array;
        } else if ((typeof ctx === 'undefined' ? 'undefined' : _typeof(ctx)) === 'object' && ctx !== null) {
            var object = {};
            for (var key in ctx) {
    ...
    function CheckIfBeastIsReady() {
        ...
        if (isReady) {
            for (var i = 0, ii = HttpRequestQueue.length; i < ii; i++) {
                EvalBml(HttpRequestQueue[i].responseText);
            }
            HttpRequestQueue = [];
            ProcessBmlScripts();
    ...
    function EvalBml(text) {
        ...
        if (/^[\s\n]*</.test(text)) {
            parsedText = parsedText + (document.body ? '.render(document.body)' : '.render(document.documentElement)');
        }
    ...
    Beast.domInit = function (domNode, isInnerCall, parentBemNode) {
        ...
        // ELEMENT_NODE
                ...
                if (nodeName !== null) {
                    ...
                    if (isInnerCall === undefined) {
                        var finalWalk = function finalWalk(bemNode) {
                            if (bemNode._noElems) {
                                bemNode.noElems();
                            }
    ...
    function extendDecl(decl, extDecl) {
        for (var key in extDecl) {
            ...
            } else if (_typeof(extDecl[key]) === 'object' && !Array.isArray(extDecl[key])) {
    ...
    Beast.node = function (name, attr) {
        ...
        return new BemNode(name, attr, Array.prototype.splice.call(arguments, 2));
    };
    ...
    function CompileDeclarations() {
        function extend(obj, extObj) {
            for (var key in extObj) {
                ...
                if (obj[key] === undefined) {
                    obj[key] = _typeof(extObj[key]) === 'object' ? cloneObject(extObj[key]) : extObj[key];
                } else if (typeof extObj[key] === 'function' && obj[key]._inheritedDeclFunction === undefined) {
                ...
                } else if (_typeof(extObj[key]) === 'object' && !Array.isArray(extObj[key])) {
        ...
        var forEachSelector = function forEachSelector(decl, selector) {
            ...
            if (decl.implementWith !== undefined) {
                expandHandlers.unshift(function () {
                    this.implementWith(Beast.node(decl.implementWith, undefined, this.get()));
                });
            }
        ...
        if (generatedDeclSelectors.length !== 0) {
            for (var i = 0, ii = generatedDeclSelectors.length; i < ii; i++) {
                forEachSelector(Declaration[generatedDeclSelectors[i]], generatedDeclSelectors[i]);
            }
        }
    }
                                                ...
                                                // Single node closed
                                                    ...
                                                    // Node opening end
                                                        ...
                                                        // Node closing end
                                                            ...
                                                            else if (!(inNode && !inNodeAttrValue && char === '/' && nextChar === '>') && !(inNodeAttrName && char === '=' && nextChar !== '=')) {
                                                                    // Unexpected char
                                                                    throw 'BML syntax error: Unexpected token "' + char + '": \n' + string.substring(0, i + 1).split('\n').slice(-5).join('\n') + '\n' + js.slice(-100);
                                                                }
                }
    ...
    Beast.patchDom = function (parentDomNode, newNode, oldNode, newIndex, oldIndex, oldParentNode) {
        ...
        if (newNode !== undefined && newNode._domNode !== undefined) {
            ...
            while (newNode._domNode !== parentDomNode.childNodes[newIndex]) {
                ...
                parentDomNode.appendChild(typeof oldNodeReplacing === 'string' ? parentDomNode.childNodes[newIndex] : oldNodeReplacing._domNode);
            }
        ...
        // create newNode DOM and decrement oldIndex
                ...
                if (newNode instanceof BemNode) {
                    ...
                    parentDomNode.appendChild(document.createTextNode(newNode));
                }
                return true;
            }
            ...
            // remove the rest oldNodes DOM
                    ...
                    while (parentDomNode.childNodes[newIndex] !== undefined) {
                        ...
                        if (oldNodeReplacing instanceof BemNode) {
                            ...
                            oldParentNode._children.splice(oldIndex, 1);
                            parentDomNode.removeChild(parentDomNode.childNodes[newIndex]);
                        }
                    }
                ...
                else if ((typeof newNode === 'undefined' ? 'undefined' : _typeof(newNode)) !== (typeof oldNode === 'undefined' ? 'undefined' : _typeof(oldNode)) || typeof newNode === 'string' && newNode !== oldNode || newNode._tag !== oldNode._tag) {
                        if (newNode instanceof BemNode) {
                            newNode.render();
                            if (parentDomNode.childNodes[newIndex + 1] !== undefined) {
                                parentDomNode.removeChild(parentDomNode.childNodes[newIndex + 1]);
                            }
                        } else {
                            parentDomNode.replaceChild(document.createTextNode(newNode), parentDomNode.childNodes[newIndex]);
                        }
        ...
        if (newNode instanceof BemNode) {
            ...
            for (var i = 0; i < newNodeChildrenNum; i++) {
                ...
                for (var j = 0; j < oldNodeChildrenNum; j++) {
                    ...
                    if (newNodeChild._hashGlobal === oldNodeChild._hashGlobal || newNodeChild._hashLocal === oldNodeChild._hashLocal && !oldNodeChild._linkedWithHashLocal && newNodeChild._domNode === undefined) {
            ...
            for (var i = 0, oldNodeIndexDec = 0, patchResult; i < newNodeChildrenNum || i < oldNodeChildrenNum + oldNodeIndexDec; i++) {
                patchResult = Beast.patchDom(newNode._domNode, newNode._children[i], oldNode._children[i - oldNodeIndexDec], i, i - oldNodeIndexDec, oldNode);
     ...
     */
    var BemNode = function BemNode(nodeName, attr, children) {
    ...
    BemNode.prototype = {
         ...
         * Defines declaraion
         */
        _defineDeclarationBySelector: function _defineDeclarationBySelector(selector) {
         ...
         */
        _defineUserMethods: function _defineUserMethods(selector) {
         ...
         */
        _clearUserMethods: function _clearUserMethods() {
         ...
         */
        inherited: function inherited(caller) {
            if (caller && caller._inheritedDeclFunction !== undefined) {
                caller._inheritedDeclFunction.apply(this, Array.prototype.splice.call(arguments, 1));
            }
         ...
         * @return boolean
         */
        isKindOf: function isKindOf(selector) {
            selector = selector.toLowerCase();
         ...
         */
        parentBlock: function parentBlock(bemNode, dontAffectChildren) {
            if (bemNode !== undefined) {
                if (this._isElem && bemNode instanceof BemNode && bemNode !== this._parentBlock) {
                    ...
                    this._defineDeclarationBySelector(this._parentBlock._selector + '__' + this._nodeName.toLowerCase());
                ...
                return this._implementedNode !== undefined ? this._implementedNode._parentBlock : this._parentBlock;
            }
        },
         ...
         */
        _setParentBlockForChildren: function _setParentBlockForChildren(bemNode, parentBlock) {
            for (var i = 0, ii = bemNode._children.length; i < ii; i++) {
         ...
         */
        parentNode: function parentNode(bemNode) {
            if (bemNode !== undefined) {
         ...
         */
        domAttr: function domAttr(name, value, domOnly) {
            if ((typeof name === 'undefined' ? 'undefined' : _typeof(name)) === 'object') {
                for (var key in name) {
                    this.domAttr(key, name[key]);
                }
            } else if (value === undefined) {
         ...
         */
        defineMod: function defineMod(defaults) {
         ...
         * @defaults     object
         */
        _extendProperty: function _extendProperty(propertyName, defaults, force) {
         ...
         */
        defineParam: function defineParam(defaults) {
         ...
         */
        mod: function mod(name, value, data) {
            if (name === undefined) {
                return this._mod;
         ...
         */
        state: function state(name, value, recursiveCall) {
            if (name === undefined) {
                return this._state;
            } else if (typeof name === 'string') {
                name = name.toLowerCase();
         ...
         */
        toggleMod: function toggleMod(name, value1, value2) {
            if (!this.mod(name)) {
         ...
         * @handler function
         */
        on: function on(event, handler, isSingleEvent, fromDecl, dontCache) {
         ...
         * @handler  function
         */
        onWin: function onWin(event, handler, isSingleEvent, fromDecl, dontCache) {
            if (typeof handler !== 'function') {
                return this;
            }
         ...
         */
        onMod: function onMod(modName, modValue, handler, fromDecl) {
        ...
        trigger: function trigger(eventName, data) {
            if (this._domNode !== undefined) {
                this._domNode.dispatchEvent(data !== undefined ? new CustomEvent(eventName, { detail: data }) : new Event(eventName));
            }
         ...
         * @data      anything Additional data
         */
        triggerWin: function triggerWin(eventName, data) {
            if (this._domNode !== undefined) {
                eventName = this.parentBlock()._nodeName + ':' + eventName;
                window.dispatchEvent(data !== undefined ? new CustomEvent(eventName, { detail: data }) : new Event(eventName));
            }
         ...
         * @return number
         */
        index: function index(allowStrings) {
         ...
         */
        _removeFromParentBlockElems: function _removeFromParentBlockElems() {
            var parentBlock;
         ...
         */
        _addToParentBlockElems: function _addToParentBlockElems() {
            var parentBlock;
            ...
            if (this._windowEventHandlers !== undefined) {
                for (var eventName in this._windowEventHandlers) {
                    for (var i = 0, ii = this._windowEventHandlers[eventName].length; i < ii; i++) {
                        window.removeEventListener(eventName, this._windowEventHandlers[eventName][i]);
                    }
                }
            }
        ...
        detach: function detach() {
            ...
            if (this._parentNode) {
                this._parentNode._children.splice(this._parentNode._children.indexOf(this), 1);
         ...
         */
        insertChild: function insertChild(children, index) {
            for (var i = 0, ii = children.length; i < ii; i++) {
                ...
                if (this._domNode && !this._isReplaceContext) {
                    this._renderChildWithIndex(index === -1 ? childrenToChange.length - 1 : index);
                }
            }
         ...
         */
        appendTo: function appendTo(bemNode) {
            bemNode.append(this);
            return this;
        },
         ...
         * @bemNode object Target
         */
        prependTo: function prependTo(bemNode) {
         ...
         */
        replaceWith: function replaceWith(bemNode, ignoreDom) {
         ...
         */
        _resetParentBlockForChildren: function _resetParentBlockForChildren() {
            for (var i = 0, ii = this._children.length; i < ii; i++) {
         ...
         * @ignoreDom boolean Private flag - do not change DOM; used in toHtml() method
         */
        implementWith: function implementWith(bemNode, ignoreDom) {
            this._cssClasses = undefined;

            if (this._domNodeEventHandlers !== undefined) {
                bemNode._domNodeEventHandlers = bemNode._domNodeEventHandlers === undefined ? this._domNodeEventHandlers : console.error('TODO: Extend handler objects');
            ...
            if (this._windowEventHandlers !== undefined) {
                bemNode._windowEventHandlers = bemNode._windowEventHandlers === undefined ? this._windowEventHandlers : console.error('TODO: Extend handler objects');
            }

            if (this._modHandlers !== undefined) {
                bemNode._modHandlers = bemNode._modHandlers === undefined ? this._modHandlers : console.error('TODO: Extend handler objects');
            }
        ...
        elem: function elem() {
            ...
            for (var i = 0, ii = this._elems.length, elem; i < ii; i++) {
                ...
                for (var j = 0, jj = arguments.length, elemName; j < jj; j++) {
                    ...
                    if (elem._nodeName === elemName || elem._implementedNode && elem._implementedNode._nodeName === elemName) {
                        elems.push(elem);
                    }
                }
            }
                    ...
                    for (var j = 0, jj = pathItems.length; j < jj; j++) {
                        ...
                        if (j === 0) {
                            ...
                            for (var k = 0, kk = prevCollection.length; k < kk; k++) {
                                collection = collection.concat(this._filterChildNodes.call(prevCollection[k], pathItem));
                            }
                        }
         ...
         */
        _filterChildNodes: function _filterChildNodes(name) {
            if (name === '..') {
                return [this._parentNode];
            }
            ...
            for (var i = 0, ii = this._children.length; i < ii; i++) {
                var child = this._children[i];
                if (child instanceof BemNode && (name === '' || name === child._nodeName || child._implementedNode && name === child._implementedNode._nodeName)) {
         ...
         */
        afterDomInit: function afterDomInit(handler) {
            if (!this._domInited) {
         ...
         * Clones itself
         */
        clone: function clone(parentNodeOfClone) {
            var clone = {};
            ...
            for (var key in this) {
                if (key === '_children') {
                    var cloneChildren = [];
                    for (var i = 0, ii = this._children.length; i < ii; i++) {
                        cloneChildren.push(this._children[i] instanceof BemNode ? this._children[i].clone(clone) : this._children[i]);
                    }
         ...
         */
        render: function render(parentDOMNode) {
            ...
            if (parentDOMNode) {
                ...
                this._parentNode._domNode.insertBefore(this._domNode, this._parentNode._domNode.childNodes[this.index(true)] || null);
            }
         ...
         */
        _renderChildWithIndex: function _renderChildWithIndex(index) {
            var child = this._children[index];

            if (child instanceof BemNode) {
                child.render();
            } else {
                this._domNode.insertBefore(document.createTextNode(child), this._domNode.childNodes[index] || null);
            }
        },
         ...
         */
        _completeExpand: function _completeExpand() {
         ...
         */
        _callModHandlers: function _callModHandlers(modName, modValue, data) {
            var handlers;
         ...
         * Sets DOM classes
         */
        _setDomNodeClasses: function _setDomNodeClasses(returnClassNameOnly, finalMod) {
            if (this._cssClasses === undefined) {
                ...
                for (var key in this._mod) {
                    ...
                    tail = value === true ? '_' + key : '_' + key + '_' + value;

                    if (finalMod === undefined || finalMod[key] === undefined && finalMod._selector[this._selector] === undefined || finalMod[key] !== undefined && finalMod[key][this._selector] === true) {
                    ...
                    if (this._flattenInheritsForDom) {
                        for (var i = 0, ii = this._flattenInheritsForDom.length, selector; i < ii; i++) {
                            ...
                            if (finalMod === undefined || finalMod[key] === undefined && finalMod._selector[selector] === undefined || finalMod[key] !== undefined && finalMod[key][selector] === true) {
        ...
        _assignDomClasses: function _assignDomClasses() {
         ...
         * Sets DOM CSS
         */
        _setDomNodeCSS: function _setDomNodeCSS(propertyToChange, isAnimationFrame) {
            if (isAnimationFrame) {
         ...
         * @return string
         */
        toStringOfFunctions: function toStringOfFunctions() {
            var attr = '{';
            for (var key in this._mod) {
            ...
            return 'Beast.node(' + '"' + this._nodeName + '",' + (attr === '{}' ? 'undefined' : attr) + (children ? ',' + children + ')' : ')');
        },
        ...
        expand: function expand() {
            ...
            if (this._implementedNode && this._implementedNode._decl && this._implementedNode._decl.domInit) {
        ...
        renderState: function renderState() {
            ...
            clone.__proto__ = this.__proto__;
            for (var i in this) {
                if (i === '_css' || i === '_domAttr' || i === '_mod' || i === '_modHandlers' || i === '_domNodeEventHandlers' || i === '_windowEventHandlers') {
         ...
         */
        _expandForRenderState: function _expandForRenderState(isNewNode) {
